...
extern void Write_x1(u64 Count, u8 *Data);
extern void Write_x2(u64 Count, u8 *Data);
extern void Write_x3(u64 Count, u8 *Data);
extern void Write_x4(u64 Count, u8 *Data);
#pragma comment (lib, "./bin/write_unroll")
